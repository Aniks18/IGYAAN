...
export const ROLE_ACCESS = {
	...
	academicSessions:    ['super_admin','co_admin','faculty'],
	...
	// Administration
	transfer:            ['super_admin','co_admin','faculty'],
...
const AcademicSessionsIcon = (props) => (
	<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className="h-[18px] w-[18px]" {...props}>
		<path d="M8 2v4" />
		<path d="M16 2v4" />
		<rect x="3" y="4" width="18" height="17" rx="2" />
		<path d="M3 10h18" />
		<path d="M14 14.5a2.5 2.5 0 1 1-2.2 3.7" />
		<path d="M14 12.5v2h-2" />
	</svg>
);
...
const TransferIcon = (props) => (
	<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" className="h-[18px] w-[18px]" {...props}>
		...
		<path d="M2 12l2.5-2.5L7 12" />
		<path d="M22 12l-2.5 2.5L17 12" />
	</svg>
);
...
// ── Admin Navigation (Figma Match) ───────────────────────────────
export const ADMIN_NAV = [
	{
		items: [
			{ key: 'dashboard', name: 'Dashboard', href: '/dashboard', icon: DashboardIcon, isCustomIcon: true },
			{ key: 'tools', name: 'Teaching Tools Kit', href: '/dashboard/tools', icon: ToolsIcon, isCustomIcon: true },
			{ key: 'liveClassroom', name: 'Omni Sight (Live Classroom)', href: '/dashboard/live-classroom', icon: VideoIconCustom, isCustomIcon: true },
		],
	},
	{
		...
		items: [
			{ key: 'pitchCraft', name: 'Pitch Craft / Slide Creation', href: '/dashboard/content-generator', icon: PitchCraftIcon, isCustomIcon: true },
			{ key: 'incubationHub', name: 'Incubation Hub', href: '/dashboard/incubation-hub', icon: IncubationIcon, isCustomIcon: true },
		],
	},
	{
		...
		labelColor: 'text-slate-400',
		items: [
			{ key: 'studentManagement', name: 'Student', href: '/dashboard/student-management', icon: StudentIcon, isCustomIcon: true },
			{ key: 'facultySubstitution', name: 'Faculty', href: '/dashboard/faculty-substitution', icon: FacultyIcon, isCustomIcon: true },
			{ key: 'academics', name: 'Classes', href: '/dashboard/classes', icon: ClassesIcon, isCustomIcon: true },
			{ key: 'academicSessions', name: 'Academic Sessions', href: '/dashboard/academic-sessions', icon: AcademicSessionsIcon, isCustomIcon: true },
			{ key: 'transfer', name: 'Transfer', href: '/dashboard/transfer', icon: TransferIcon, isCustomIcon: true },
	...
	},
	{
		...
		items: [
			...
			{ key: 'eventsManagement', name: 'Events', href: '/dashboard/events', icon: EventsIcon, isCustomIcon: true },
		],
	},
	{
		label: 'SYSTEM & USERS',
		labelColor: 'text-slate-400',
		items: [
			{ key: 'schoolProfile', name: 'School Profile', href: '/dashboard/school-profile', icon: SchoolProfileIcon, isCustomIcon: true },
			{ key: 'userManagement', name: 'User Management', href: '/dashboard/users', icon: UserManagementIcon, isCustomIcon: true },
			{ key: 'userAccess', name: 'Access & Roles', href: '/dashboard/user-access', icon: AccessRolesIcon, isCustomIcon: true },
			{ key: 'settings', name: 'Settings', href: '/dashboard/settings', icon: SettingsNavIcon, isCustomIcon: true },
		],
	},
];
